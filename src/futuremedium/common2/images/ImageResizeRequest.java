 ...
 * 
 * This is based heavily on the work done for image resizing in autopublish, but
 * without any of the benefits of being able to use ImageMagik. In addition to
 * parameters to influence the output, you must pass in the source information
 * for the image as one of the following, with increasing priority if multiple
 * provided: absolute path to file, File object, BufferedImage object.
 * 
